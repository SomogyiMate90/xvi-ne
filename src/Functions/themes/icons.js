...
const calendarIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-calendar-day" viewBox="0 0 16 16">
...
export { downMark, downMark2, faceBookIcon,youTubeIcon, akadalymentesIkon, moon, sun, pictureIcon, calendarIcon };
