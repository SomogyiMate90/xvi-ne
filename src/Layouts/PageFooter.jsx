        ...
        <footer className="m-0">
            ...
            <address className="row gx-0 gy-lg-2">
              <div className="col-12 col-md-6 col-lg-6 col-xl-12 d-xl-flex gap-2 justify-content-evenly align-items-center col-xxl-7" >
                <p className="text-indent-no">Telephely:<br className="d-sm-none d-md-block d-xxl-none"/> 1165 Budapest, Veres Péter út 157. <MapBtn className='d-inline' address='1165 Budapest, Veres Péter út 157' /> </p>
