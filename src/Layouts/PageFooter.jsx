  ...
  return (
    <div className={`page-footer ${theme}`}>
        <footer className="m-0">
            ...
            <div className="d-flex flex-column align-items-center col-12 col-md-6 col-lg-6 col-xl-12 flex-xl-row gap-xl-4 justify-content-center align-items-center col-xxl-5 pe-xxl-3">
